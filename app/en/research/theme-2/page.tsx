  ...
  return (
    <PageLayout language="en">
      ...
      <article className="entry-content research-detail">
        ...
        <Publication href="https://www.biorxiv.org/content/10.64898/2026.09.13.751222v1" title="Gut bacterial composition and predicted functional profiles associated with depressive symptom burden in Japanese adults recruited independently of depression diagnosis." authors="Shunsuke Ichikawa, Aiko Hoshino, Shun Okuhara." journal="bioRxiv. 2026." />
